...
import pytest
from pages.rms_pages import RMSHome, RMSClubStanding


def test_global_search_runner_full_name(web_browser):
    """Check that possible find any runner by Runner Full name"""

    home_page = RMSHome(web_browser)
    ...
    # clubstandings_page = RMSClubStanding(web_browser)
    # current_url = clubstandings_page.get_current_url()
    # assert current_url == "http://192.168.51.7:8215/clubstandings"
